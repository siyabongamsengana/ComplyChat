...
Only the right people can see the right messages (access control)
There's a record of who did what and when (audit log); so if something goes wrong, you can trace it back
Old messages get deleted after a set time, following privacy law rules (retention policy)
